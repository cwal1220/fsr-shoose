...
void loop() {
  ...
  else
  {
    ...
    sensorDataJson["left_0"] = getFsrData(FSR_0);
    sensorDataJson["left_1"] = getFsrData(FSR_1);
    sensorDataJson["left_2"] = getFsrData(FSR_2);
    sensorDataJson["left_3"] = getFsrData(FSR_3);
    sensorDataJson["left_4"] = getFsrData(FSR_4); 
